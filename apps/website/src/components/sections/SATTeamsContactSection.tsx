...
interface SATTeamsContactSectionProps {
  language?: 'en' | 'no';
}

export const SATTeamsContactSection: React.FC<SATTeamsContactSectionProps> = ({
  language = 'en',
}) => {
  const content = {
    en: {
      ...
      sectionDescription:
        'Start measuring your training program effectiveness today with no commitment. Install directly from Microsoft Azure Marketplace.',
      leftContent: {
        ...
        benefits: [
          'Complete training effectiveness measurement tools',
          'Behavioral change analytics and insights dashboard',
          'Program optimization reports and recommendations',
          'Research hub access with latest SAT methodologies',
          'Microsoft Graph integration for seamless deployment',
          'Expert training coordinator onboarding and guidance included',
        ],
        contactInfo: {
    ...
    no: {
      ...
      sectionDescription:
        'Start måling av ditt treningsprogram effektivitet i dag uten forpliktelser. Installer direkte fra Microsoft Azure Marketplace.',
      leftContent: {
        ...
        benefits: [
          'Komplette trenings effektivitet måling verktøy',
          'Atferds endring analytikk og innsikt dashbord',
          'Program optimalisering rapporter og anbefalinger',
          'Forskningshub tilgang med siste SAT metodikker',
          'Microsoft Graph integrasjon for sømløs utplassering',
          'Ekspert trenings koordinator innføring og veiledning inkludert',
        ],
        contactInfo: {
          ...
          <div className="bg-praxis-white rounded-2xl shadow-xl p-8">
            <div className="text-center mb-8">
              ...
              <p className="text-praxis-dark-blue-600 mb-6">
                {language === 'no'
                  ? 'Installer Praxis Navigator direkte fra Microsoft Azure Marketplace og få umiddelbar tilgang til alle trenings analytikk funksjoner.'
                  : 'Install Praxis Navigator directly from Microsoft Azure Marketplace and get instant access to all training analytics features.'}
              </p>
            </div>
            ...
            <div className="mb-8">
              ...
              <ul className="space-y-3">
                {[
                  language === 'no'
                    ? 'Komplett trenings effektivitet måling'
                    : 'Complete training effectiveness measurement',
                  language === 'no'
                    ? 'Program optimalisering dashbord'
                    : 'Program optimization dashboard',
                  language === 'no'
                    ? 'Forskningshub tilgang'
                    : 'Research hub access',
                  language === 'no'
