  ...
  no: {
    ...
    about: {
      ...
      kaiRoer: {
        ...
        bio: 'Kai Roer bidrar til utviklingen av sikkerhetskultur måling og adferdsendring i cybersikkerhet.',
        background:
          'Med over 25 års erfaring innen cybersikkerhets-forskning og praksis, har Kai fokusert på å forstå og forbedre menneskelige faktorer i informasjonssikkerhet.',
        achievements: [
          ...
          'Foredragsholder på over 100 internasjonale konferanser',
          'Forfatter av 50+ forskningsartikler om sikkerhetskultur',
        ],
      },
    },
    ...
    pricing: {
      ...
      table: {
        ...
        sectionDescription:
          'Åpne priser tilpasset organisasjoner av alle størrelser. Alle planer inkluderer våre kjernefunksjoner for måling av sikkerhetskultur.',
        billingToggle: {
          monthly: 'Månedlig',
          annual: 'Årlig',
        },
        ...
        currency: {
          note: 'Priser i Euro. Fakturering kan også skje i NOK etter gjeldende kurs.',
          vat: 'Alle priser er eksklusive mva. (25% i Norge)',
          payment:
            'Vi aksepterer bankoverføring, kredittkort og fakturaordning',
        },
        compliance: {
          gdpr: 'GDPR-kompatibel og hostet i Europa',
          personalData: 'Overholder Personopplysningsloven',
          dataLocation: 'Alle data lagres i EU/EØS',
        },
        commonFeatures: [
        ...
        plans: [
          {
            id: 'small',
            name: 'Små Virksomheter',
            priceAnnual: '€199',
            priceMonthly: '€249',
            period: 'per måned',
            description: 'Egnet for organisasjoner opptil 199 ansatte',
            features: [
              'Opptil 199 ansatte',
              'Standard e-poststøtte',
              'Grunnleggende rapportering',
              'Månedlige sikkerhetsinnsikter',
              'Kjerne adferdsanalyse',
              'Microsoft Graph integrasjon',
            ],
            ctaText: 'Start Gratis Prøveversjon',
            supportLevel: 'E-poststøtte i arbeidstiden',
            highlighted: false,
          },
          {
            id: 'medium',
            name: 'Mellomstore Virksomheter',
            priceAnnual: '€249',
            priceMonthly: '€299',
            period: 'per måned (fra)',
            description: 'Ideell for voksende bedrifter med 200+ ansatte',
            features: [
              '200+ ansatte',
              'Prioritert e-poststøtte',
              'Utvidet rapporteringssuite',
            ...
            ctaText: 'Start Gratis Prøveversjon',
            supportLevel: 'Prioritert e-poststøtte samme dag',
            highlighted: true,
          },
          {
            id: 'large',
            name: 'Store Virksomheter',
            ...
            features: [
              ...
              'Merkevaretilpasset rapportering',
              'Sanntids innsikter',
              'Avansert AI analyse',
    ...
    contact: {
      ...
      info: {
        email: 'norge@praxisnavigator.io',
        phone: '+47 21 09 50 00',
        address: 'Karl Johans gate 20, 0159 Oslo, Norge',
        hours: 'Mandag - Fredag: 08:00 - 16:00 (CET)',
        timezone: 'Sentraleuropeisk tid (CET/CEST)',
        culturalNote:
          'Vi respekterer norske arbeidstidskonvensjoner og ferieperioder',
      },
    },
